classdef sortedCollection < lfpBattery.composite
    %SORTEDCOLLECTION Abstract class for storing functions of x and y with
    %different z values.
    %
    ...
    methods
        function c = sortedCollection(varargin)
