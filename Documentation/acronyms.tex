...
\begin{acronym}
	...
	\acro{dgemm}[dgemm] Engl.: double-precision general matrix-matrix multiplication
	\acro{EOL}[EOL] end of life
	\acro{GUI}[GUI] graphical user interface
	\acro{JIT}[JIT] \matlab\ just-in-time compiler
	\acro{JVM}[JVM] \java\ virtual machine
	\acro{LFP}[LFP] lithium iron phosphate
