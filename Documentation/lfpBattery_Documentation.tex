...
%\include{terminology}
\include{dischargeCurves}
\include{ageModel}
\include{batteryInterface}
\addcontentsline{toc}{section}{References}
\printbibliography
%TODO explain that import must be called
%TODO CCCV fit section
%TODO digitizeTool section
%TODO replace umlauts in .bib file
%TODO In GUI section, note that it is not recommended to save battery objects, since every object reference is converted to a deep copy, possibly resulting in high memory usage
\end{document}